...
const middle = {
    ...
    children: [
        ...
        },
        {
            ...
            name: '3.4.Animation',
            meta: {title: '4.动画'},
            component: () => import('@/views/manual/3.middle/4.animation'),
        },
        {
            path: '5.plugins',
            name: '3.5.Plugins',
            meta: {title: '5.插件'},
            component: () => import('@/views/manual/3.middle/5.plugins'),
            redirect: '/manual/3.middle/5.plugins/1.menu',
            children: [
                {
                    path: '1.menu',
                    name: '3.5-1.Menu',
